...
library TEscrow {
    ...
    /// Total size: 98 bytes (rounded up to 128 bytes due to storage slot alignment).
    ...
    /// @param hasParticipated A flag to indicate whether the user has deposited his USDC or DynUSDC into the
    /// `ProjectAllocationManager` contract. (1 byte)
